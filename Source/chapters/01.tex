...
\begin{letter}
	\begin{tikzpicture}[remember picture, overlay]  
		\node (theend) at ($(current page.south)+(0cm,3.5cm)$) {\includegraphics[width=0.7\textwidth]{1tailpiece}};
	\end{tikzpicture}
...
\begin{a4}
	...
	\begin{tikzpicture}[remember picture, overlay]  
		\node (theend) at ($(current page.south)+(0cm,6cm)$) {\includegraphics[width=0.7\textwidth]{1tailpiece}};
	\end{tikzpicture}
