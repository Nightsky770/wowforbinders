...
% \begin{sidewaysfigure}
	% \includegraphics[width=.9\columnwidth]{2fallenstar}%
...
\begin{pictures} 
	\begin{letter}
		...
		\begin{tikzpicture}[remember picture, overlay]
			\node (img) at ($(current page.center)+(0.5cm,0cm)$) {\includegraphics[width=1.15\columnwidth]{2fallenstar}};
			\node[rotate=-90, text width=\textheight, align=center] (caption) at ($(current page.west)+(1cm,0cm)$) {\textsc{Taken it for an ordinary falling star}};

		\end{tikzpicture}
		\addxcontentsline{lof}{figure}{Taken it for an ordinary falling star}
		\thispagestyle{empty}
		\clearpage
	\end{letter}
