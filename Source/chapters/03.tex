...
\begin{pictures} 
	\begin{a4}
		...
		\begin{tikzpicture}[remember picture, overlay]
			\node (img) at ($(current page.center)+(-0.5cm,0cm)$) {\includegraphics[width=1.15\columnwidth]{3cratera4}};
...
\begin{pictures} 
	\begin{letter}
		\clearpage
		\begin{tikzpicture}[remember picture, overlay]
			\node (img) at ($(current page.center)+(0.5cm,0cm)$) {\includegraphics[width=1.15\columnwidth]{3crater}};
