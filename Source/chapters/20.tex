...
\begin{a4}
	\begin{figure}[tb]
	\centering
	\includegraphics[width=.7\linewidth]{20defeated}
	\end{figure}
\end{a4}
...
\begin{a4}
	\begin{figure}[tb]
	\centering
	\includegraphics[width=.7\linewidth]{20cuddlepuddle}
	\end{figure}
\end{a4}
...
\begin{a4}
	\begin{tikzpicture}[remember picture, overlay]  
		\node (tailpiece) at ($(current page.south)+(0cm,4cm)$) {\includegraphics[width=.6\linewidth]{20tailpiece}};
	\end{tikzpicture}
