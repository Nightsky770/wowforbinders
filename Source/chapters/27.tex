...
\begin{a4}
	\begin{tikzpicture}[remember picture, overlay]  
		\node (theend) at ($(current page.south)+(0cm,5cm)$) {\includegraphics[width=.5\textwidth]{27tailpiece}};
	\end{tikzpicture}
...
\begin{letter}
	...
	\begin{tikzpicture}[remember picture, overlay]  
		\node (theend) at ($(current page.south)+(0cm,6cm)$) {\includegraphics[width=.6\textwidth]{27tailpiece}};
	\end{tikzpicture}
