...
\rule{0.5\textwidth}{.4pt}
\vfill
\textit{The War of the Worlds} (Herbert George »H.G.« Wells, 1866\textendash1946) was serialised in \textit{Pearson's Magazine} (in the UK) and \textit{Cosmopolitan} magazine (in the US) in 1897. In 1898, it was published in hardback by William Heinemann (in the UK) and Harper \& Bros. (in the US). 
\vfill
\rule{0.5\textwidth}{.4pt}
\vfill
